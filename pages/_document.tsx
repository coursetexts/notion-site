      ...
      <IconContext.Provider value={{ style: { verticalAlign: 'middle' } }}>
        <Html lang='en'>
          <Head>
            ...
            <link
              href='https://fonts.googleapis.com/css2?family=DM+Mono:wght@400;500;700&display=optional'
              rel='stylesheet'
            ></link>
            <link
            ...
            ></link>
            <link
              href='https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=PT+Serif:ital,wght@0,400;0,700;1,400;1,700&display=optional'
              rel='stylesheet'
            ></link>
