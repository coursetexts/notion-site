...
export default function CommunityResourcesPage() {
  ...
  const setCommentCount = (id: string, count: number) => {
    setResources((prev) => {
      ...
      if (!current || current.commentCount === count) return prev
      return prev.map((r) => (r.id === id ? { ...r, commentCount: count } : r))
    })
  }
      ...
      {modal === 'resource' && (
        <Modal title='Share a resource' onClose={closeModal}>
          ...
          <div className={styles.field}>
            ...
            <FormSelect<ResourceType>
              labelledBy='share-resource-type-label'
              value={resType}
