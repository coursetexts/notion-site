...
export default function ProfilePage() {
  ...
  const [myActivityTab, setMyActivityTab] = useState<
            ...
            <>
              <div className={styles.section}>
                ...
                {activityLoading ? (
                  ...
                  <p className={styles.placeholder}>
                    No bookmarks yet. Use “Save course” on a course page to add
                    one.
                  </p>
                ) : (
              ...
              <div className={styles.section}>
                ...
                {activityLoading ? (
                  ...
                  <p className={styles.placeholder}>
                    No replies yet. When someone replies to your comment or
                    annotation, it appears here.
                  </p>
                ) : (
                  <ul className={styles.list}>
                    {notifications.map((n) => (
              ...
              <div className={styles.section}>
                ...
                {!activityLoading &&
                  ...
                  (annotations.length === 0 ? (
                    <p className={styles.placeholder}>
                      You haven’t added annotations yet. Annotations you leave
                      in course sections will appear here.
                    </p>
                  ) : (
                    <ul className={styles.list}>
              ...
              <div className={styles.section}>
                ...
                <div className={styles.linkFilterRow}>
                  ...
                  <>
                    <span className={styles.linkFilterDivider} aria-hidden>
                      |
                    </span>
                    <button
                      type='button'
                        ...
                        <li key={l.id} className={styles.userLinkItem}>
                          <div className={styles.userLinkItemInner}>
                            ...
                            <div className={styles.userLinkContent}>
                              ...
                              <div className={styles.userLinkMeta}>
                                {l.is_private && (
                                  <button
                                    ...
                                    onClick={() =>
                                      setShowPrivateMessageForLinkId((id) =>
                                        id === l.id ? null : l.id
                                      )
                                    }
                              ...
                              {l.note && (
                                <p className={styles.userLinkNote}>{l.note}</p>
                              )}
                            </div>
                          </div>
                        </li>
                        ...
                        <>
                          ...
                          <div className={styles.actionOverlayActions}>
                            ...
                            <button
                              ...
                              onClick={() =>
                                handleDeleteLink(linkActionOverlay.link.id)
                              }
                            >
                              Delete
                            </button>
