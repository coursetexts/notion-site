...
| `/all-courses?view=learning-paths` | Public **community + research** cards (`listNonCourseLearningPaths`). Visible **Academic Courses \| Learning Paths** filter vs the default courses catalog. Create-path promo; empty search opens the create modal. |
