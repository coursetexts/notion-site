...
Shared chrome on home, catalog, community, profile, course, and about pages. Desktop nav is **Explore** · **Create a path** · **Community** · **About** (plus search). **Explore**, **Community**, and **About** are icon + title + description flyouts; the panel left-aligns so each item title lines up with the trigger label.
