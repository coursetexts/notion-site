...
| About                      | `/manifesto`, `/about`, `/process`, `/professors`, `/support`    | Header **About** goes to `/about` (dropdown: Why / Professors / Blog / Support / Paths). `/about` is a custom landing + inaugural essay (`pages/about.tsx`) with hover glossary definitions (`DefinedTerm` / `GlossaryTerm`, including autodidact); manifesto remains the Why page; `/process` remains a Notion override. Blog is `blog.coursetexts.org`.                                                                                                                                                                                                                                    |
