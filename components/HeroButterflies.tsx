  ...
  return (
    <>
      ...
      <svg style={{ display: 'none' }}>
        ...
        >
          <path
            d='M2.34711 11.021C9.05935 11.021 16.4062 11.0921 22.4207 14.529C25.2881 16.1675 28.6572 25.5296 28.6572 22.2271C28.6572 12.7972 25.2473 2.25093 37.4273 2.25093'
            stroke='black'
            strokeWidth='3'
            strokeLinecap='round'
          />
