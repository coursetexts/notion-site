...
const INTRO_COPY: Record<DegreeLevel, string> = {
  undergraduate:
    "Coursetexts' curated curriculum covers the 50 most common undergraduate degrees, helping self-learners structure their learning and linking them to world-class resources. Each course is created using syllabi from the top 10 schools offering the degree. Expand a degree to see its course learning paths.",
  graduate:
    "Coursetexts' curated curriculum covers the 50 most common graduate degrees, helping self-learners structure their learning and linking them to world-class resources."
}
