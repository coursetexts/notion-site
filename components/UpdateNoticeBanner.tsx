    ...
    <div className={styles.UpdateNoticeBanner}>
      ...
      <div>
        <span className={styles.cursive}>
          🌱 We are always updating Coursetexts.{' '}
        </span>
        These notes are drafts and meant to be more up-to-date than they are
        polished. If you spot a typo, please let us know at{' '}
        <a
          target='_blank'
          rel='noopener noreferrer'
          href='mailto:coursetexts@mit.edu'
        >
          coursetexts@mit.edu
        </a>
        !
