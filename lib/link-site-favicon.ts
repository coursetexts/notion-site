...
const MAJOR_SITES: { match: (host: string) => boolean; domain: string }[] = [
  ...
  },
  {
    match: (h) =>
      ...
      h.endsWith('amazon.fr') ||
      h.endsWith('amazon.ca') ||
      h.endsWith('amazon.in') ||
      h.endsWith('amazon.jp'),
    domain: 'amazon.com'
  },
  {
  ...
  {
    match: (h) => h === 'substack.com' || h.endsWith('.substack.com'),
    domain: 'substack.com'
  },
  {
  ...
  {
    match: (h) => h === 'twitter.com' || h.endsWith('.twitter.com'),
    domain: 'x.com'
  },
  {
    match: (h) =>
      h === 'youtube.com' || h.endsWith('.youtube.com') || h === 'youtu.be',
    domain: 'youtube.com'
  },
  {
    match: (h) => h === 'quora.com' || h.endsWith('.quora.com'),
    domain: 'quora.com'
  },
  {
    match: (h) => h === 'stackoverflow.com' || h.endsWith('.stackoverflow.com'),
    domain: 'stackoverflow.com'
  },
  {
    match: (h) =>
      h === 'discord.com' || h.endsWith('.discord.com') || h === 'discord.gg',
    domain: 'discord.com'
  },
  {
    match: (h) => h === 'medium.com' || h.endsWith('.medium.com'),
    domain: 'medium.com'
  },
  {
    match: (h) => h === 'jstor.org' || h.endsWith('.jstor.org'),
    domain: 'jstor.org'
  },
  {
    match: (h) => h === 'researchgate.net' || h.endsWith('.researchgate.net'),
    domain: 'researchgate.net'
  },
  {
    match: (h) => h === 'quizlet.com' || h.endsWith('.quizlet.com'),
    domain: 'quizlet.com'
  }
]
