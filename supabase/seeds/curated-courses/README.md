# Curated course SQL seeds

Run these in the Supabase SQL Editor after schema migrations (`013` / `014`, or `000_complete_schema.sql`).

| File | Purpose |
|------|---------|
| `seed_curated_course_video_courses.sql` | Catalog: slug + title for degrees courses |
| `seed_fluid_mechanics_curated_course.sql` | Fluid Mechanics full tree + videos + resources (self-contained schema repair) |
...
JSON source of truth: [`data/curated-courses/`](../../../data/curated-courses/).
Docs: [`docs/curated-courses.md`](../../../docs/curated-courses.md).
